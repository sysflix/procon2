        ...
        <div id="app">
            <header class="with-background">
                ...
                <div class="hero container">
                    <div class="hero-copy">
                        <h1>Procon Ecommerce </h1>
                        <p>We are a company having 21 years of service excellence in providing sophisticated ICT solutions.</p>
            ...
            <div class="featured-section">
                ...
                <div class="container">
                    <h1 class="text-center">Procon Ecommerce </h1>
